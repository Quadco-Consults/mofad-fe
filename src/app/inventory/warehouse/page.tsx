...
import { Eye, CheckCircle, XCircle, Plus, Package, Warehouse, AlertTriangle, TrendingUp, TrendingDown, Loader2, AlertCircle as AlertCircleIcon } from 'lucide-react'
...
export default function WarehouseInventoryPage() {
  ...
  const { data: inventoryResponse, isLoading: inventoryLoading, error: inventoryError } = useQuery({
    ...
    queryFn: () => selectedWarehouse ? api.getWarehouseInventory(selectedWarehouse) : Promise.resolve([]),
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'inventory' && (
          <div className="space-y-6">
            ...
            {/* Summary Cards */}
            {!inventoryLoading && !warehousesLoading && !inventoryError && (
              <>
                ...
                {inventoryItems.length === 0 ? (
                  <tr>
                    <td colSpan={9} className="px-6 py-12 text-center text-gray-500">
                      {selectedWarehouse ? 'No inventory items found for this warehouse.' : 'Please select a warehouse to view inventory.'}
                    </td>
                  </tr>
                ) : (

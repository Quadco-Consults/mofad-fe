...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-green-50 via-green-50 to-green-100 py-24 lg:py-32 overflow-hidden">
        {/* Background Pattern */}
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Nigeria&apos;s Premier <span className="text-green-600">Lubricants & Service</span> Provider
                </h1>
            ...
            <div className="relative">
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <p className="text-green-100">Lubricants storage and service facilities across Nigeria</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Complete <span className="text-green-600">Lubricants & Automotive</span> Solutions
            </h2>
      ...
      <section className="py-24 bg-gradient-to-br from-green-50 via-green-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-semibold mb-6">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Professional <span className="text-green-600">Lube Bays & Service</span> Centers
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
                  Keeping Nigeria <span className="text-green-600">Moving Smoothly</span> Since 2010
                </h2>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <p className="text-green-100">Automotive professionals dedicated to quality service</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="partners" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Authorized Distributor for <span className="text-green-600">Premium Brands</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-green-600 to-green-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#" className="text-gray-300 hover:text-green-400 transition-colors">Lubricants Distribution</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-green-400 transition-colors">Oil Change Services</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-green-400 transition-colors">Filter Replacement</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-green-400 transition-colors">Car Wash & Detailing</Link></li>
              </ul>
            </div>
